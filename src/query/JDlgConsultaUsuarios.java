...
public class JDlgConsultaUsuarios extends javax.swing.JDialog {
    ...
    private void jBtn_Meb_ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_Meb_ConsultarActionPerformed
        if(jTxt_Meb_Nome.getText().equals("") && jTxt_Meb_Cpf.getText().equals("")){// Verifica se ambos os campos de texto e de seleção estão vazios
         List lista = usuariosDAO.listAll();// Se ambos os campos estiverem vazios, obtém uma lista de todos os usuários
         usuariosController.setList(lista);
        } else{
            if(!jTxt_Meb_Nome.getText().equals("") && !jTxt_Meb_Cpf.getText().equals("")){// Verifica se ambos os campos de texto têm valores
             List lista = usuariosDAO.listNomeCpf(jTxt_Meb_Nome.getText(), jTxt_Meb_Cpf.getText());// Se ambos os campos tiverem valores, obtém uma lista de usuários filtrados por nome e CPF
              usuariosController.setList(lista);
          }else{
            if(! jTxt_Meb_Nome.getText().equals("")){// Verifica se apenas o campo de nome tem valor
             List lista = usuariosDAO.listNome(jTxt_Meb_Nome.getText());// Se apenas o campo de nome tiver valor, obtém uma lista de usuários filtrados por nome
              usuariosController.setList(lista);
          }else{
             if(! jTxt_Meb_Cpf.getText().equals("")) {// Verifica se apenas o campo de CPF tem valor
              List lista = usuariosDAO.listCpf(jTxt_Meb_Cpf.getText());// Se apenas o campo de CPF tiver valor, obtém uma lista de usuários filtrados por CPF
               usuariosController.setList(lista);
             }
           }
         }
